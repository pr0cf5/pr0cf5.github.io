...
Also I don't remember why I started to study binary exploitation in the first place. I think it's because it seemed cool, which is a very dumb and immature reason to start something. But I managed to convince GoN members into accepting me by showing them my 'enthusiasm' for programming and hacking. Hmmm...
